...
supersedes: docs/current/status.md
---
...
### 관련 문서
- [training_scaffold.md](../protocols/training.md) · [paper_alignment.md](../reference/paper_alignment.md) · [phase5.md](./phase5_2026-07.md)
