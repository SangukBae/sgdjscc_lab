...
7. **`Wan-AI/Wan2.1-FLF2V-14B-720P-Diffusers`는 처음 실행 시 별도로 ~84GB를
   ...
   [1B worker 검증 기록](./2026-07_lgvsc_1b_worker_validation.md) 참조.
...
- [etri_strategy.md](../current/status.md) — "후속 딥러닝 4단계", 1A/1B/1C 구현 결과
- [video_extension_lgvsc.md](../architecture/tx_rx_contract.md) — LGVSC 재현선과 ETRI
  개선선 구분, 6.0-a/6.2/6.3
- [lgvsc_1b_worker_readiness.md](./2026-07_lgvsc_1b_worker_validation.md) — 1B 실제
  GPU 검증 상세(SVD/Wan start-only/Wan bidirectional), 환경 구성, 체크포인트
  용량/시간
- [lgvsc_psss_skem_readiness.md](./2026-07_lgvsc_psss_skem.md) — 이 문서의
