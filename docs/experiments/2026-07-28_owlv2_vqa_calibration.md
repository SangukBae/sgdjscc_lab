...
- 이 문서는 [과거 구현 로그](../archive/etri_implementation_log.md) 5차(순서 8~10)가 만든 presence-backend
...
- [etri_strategy.md](../current/status.md) — 5차(순서 8~10) 구현 결과, 무엇이
  "코드 기반 스캐폴드"이고 무엇이 실제 검증인지의 전체 맥락
- [etri_video_speed_optimization.md](./2026-07-24_video_speed_optimization.md) —
