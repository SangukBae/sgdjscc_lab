...
- **SKIM/SFA 모드(`skim_sfa_fixed`)**: `keyframe.selector: fixed_interval` —
  ...
  **다른** selector다 — `fixed`는 여전히 "nearest reproducible" 근사일
  ...
  [1C 재현 문서](./2026-07_lgvsc_1c_reproduction.md)의 기존 경고가 유효하므로,
...
- [lgvsc_1c_reproduction_readiness.md](./2026-07_lgvsc_1c_reproduction.md) — 이 작업 이전의 4-모드 1C 재현선(이 문서가 그 다음 단계)
- [lgvsc_1b_worker_readiness.md](./2026-07_lgvsc_1b_worker_validation.md) — Wan/SVD 실제 GPU 검증, 체크포인트 자동 선택
- [etri_strategy.md](../current/status.md) — "후속 딥러닝 4단계" 전체 맥락
- [video_extension_lgvsc.md](../architecture/tx_rx_contract.md) — LGVSC 재현선/ETRI 개선선 설계 원안
