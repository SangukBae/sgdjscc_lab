...
| 10dB 양자화 재평가 실행 환경 | **구현·CPU dry-run 검증 완료, 실제 GPU 결과 대기** — fixed selector에서 AWGN 참고 + float32/int16/int8/int6/int4만 비교하는 3-GPU 단일 명령, 10dB 값을 config·CSV·summary·parallel plan·manifest·resume signature에 고정 |
