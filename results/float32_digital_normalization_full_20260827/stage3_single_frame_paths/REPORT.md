...
- dry_run: `False`
- videos: 1, frames/video: 1, ablations: 1
- failed_cases: 0
...
|---|---:|---|---|---|---|---|---|
| 01_person_walk | 0 | baseline | final | baseline_only | inconclusive |  | digital and in-process paths agree at every instrumented stage, and digital PSNR (35.31 dB) is not meaningfully worse than AWGN (34.59 dB, gap=-0.72 dB < 1.0 dB threshold) — no quality problem evidenc |
